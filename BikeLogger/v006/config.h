/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║  BIKELOGGER - Configuration Header (FIXED)                      ║
 * ║  Kawasaki ZX6R (1998) Telemetrie System                         ║
 * ║  Hardware: SparkFun Thing Plus ESP32-S3                         ║
 * ║  FIXME: Critical Bug #7 - Added missing LED mode definitions    ║
 * ╚══════════════════════════════════════════════════════════════════╝
 */
...
// FIXME: Critical Bug #7 - Added all LED mode definitions
// Display Modes
#define LED_MODE_SPEED 0    // Geschwindigkeit
#define LED_MODE_RPM 1      // Drehzahl (wenn verfügbar)
#define LED_MODE_LEAN 2     // Lean Angle
#define LED_MODE_GFORCE 3   // G-Force
#define LED_MODE_CUSTOM 4   // Custom pattern
#define LED_MODE_OFF 5      // All LEDs off
...
// FIXME: Critical Bug #2 - Standardized mutex timeout for consistent behavior
#define TELEMETRY_MUTEX_TIMEOUT pdMS_TO_TICKS(50)  // 50ms timeout
